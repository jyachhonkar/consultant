...
const testimonialVideos = [
  {
    src: "https://www.youtube.com/embed/o4ogadk3bLU",
    name: "Robin Singh",
    desc: "Director of Deloitte"
  },
  {
    src: "https://www.youtube.com/embed/osWOOqLIJ9A",
    name: "Mrs. Anju Parmar",
    desc: "Owner"
  }
];
...
const clientNameEl = document.getElementById("videoClientName");
const clientDescEl = document.getElementById("videoClientDesc");
const prevBtn = document.getElementById("prevVideo");
const nextBtn = document.getElementById("nextVideo");

function updateVideo(index) {
  if (!videoEl || !clientNameEl || !clientDescEl) return;
  
  // Fade out effect using GSAP since it is already included in the project
  if (window.gsap) {
    gsap.to([videoEl, clientNameEl, clientDescEl], {
      opacity: 0,
      y: -10,
      duration: 0.25,
      stagger: 0.05,
      onComplete: () => {
        ...
        clientNameEl.textContent = item.name;
        clientDescEl.textContent = item.desc;
